            ...
            <div class="media">
              <?php 
                if($user_image != '' || $user_image != null || !empty($user_image)){
                  ...
                  echo '<img src="../assets/dist/img/Barangaylogo.png" class="img-size-50 mr-3 img-circle alt="User Image">';
                }
              ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
    ...
    <?php 
        if($image != '' || $image != null || !empty($image)){
          ...
          echo ' <img src="../assets//logo//Barangaylogo.png" id="logo_image" class="img-circle elevation-5 img-bordered-sm" alt="logo" style="width: 70%;">';
        }
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../assets/dist/img/Barangaylogo.png" class="img-circle elevation-5 img-bordered-sm" alt="User Image">
        </div>
